...
export function ExplanationCard({
  ...
  return (
    <div
      className={`flex ${reverse ? 'flex-col md:flex-row-reverse' : 'flex-col md:flex-row'} mx-auto w-full max-w-4xl`}
    >
      <div
        className={`h-[324px] px-16 py-11 md:w-1/2 ${secondary && 'bg-primary'}`}
      >
        <div
      ...
      <div className="flex h-[324px] items-end justify-center bg-secondary md:w-1/2">
